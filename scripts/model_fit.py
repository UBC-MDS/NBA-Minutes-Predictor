...
path = '../data/player_data_ready.csv'
...
print('Finished Calculating Prediction Errors')
...
my_df.to_csv('../img/score_table.csv')
...
fig.write_image('../img/residual_plot.png')
...
gbm_features.save('../img/gbm_importance.png')
